...
Java_com_example_fclient_MainActivity_stringFromJNI(JNIEnv* env, jobject MainActivity) {
...
extern "C" JNIEXPORT jbyteArray JNICALL
ava_com_example_fclient_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
